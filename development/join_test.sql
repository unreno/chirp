...
IF OBJECT_ID ( 'bin.DECODE_TEST_import_into_data_warehouse_by_table_vital_births', 'P' ) IS NOT NULL
	DROP PROCEDURE bin.DECODE_TEST_import_into_data_warehouse_by_table_vital_births;
GO
CREATE PROCEDURE bin.DECODE_TEST_import_into_data_warehouse_by_table_vital_births
AS
BEGIN
	SET NOCOUNT ON;

	IF OBJECT_ID('temp_select_decode', 'U') IS NOT NULL
		DROP TABLE temp_select_decode;
--GO
...
END -- CREATE PROCEDURE bin.DECODE_TEST_import_into_data_warehouse_by_table_vital_births
GO


IF OBJECT_ID ( 'bin.JOIN_TEST_import_into_data_warehouse_by_table_vital_births', 'P' ) IS NOT NULL
	DROP PROCEDURE bin.JOIN_TEST_import_into_data_warehouse_by_table_vital_births;
GO
CREATE PROCEDURE bin.JOIN_TEST_import_into_data_warehouse_by_table_vital_births
AS
BEGIN
	SET NOCOUNT ON;

	IF OBJECT_ID('temp_select_join', 'U') IS NOT NULL
		DROP TABLE temp_select_join;
--GO
...
-- :480,880s/',\w*)/ AS VARCHAR(255))/		:480,880s/bin.decode('vital','births','/CAST (/
		CROSS APPLY ( VALUES
