...
--	street_prefix_desc only Branch, E, N, S, W
		...
		SELECT chirp_id, patient_id,
			...
			RANK() OVER( PARTITION BY patient_id ORDER BY
				...
				,mom_rzip,zip_code
				,birth_score,num_score,last_name_score,first_name_score,zip_score,mom_first_name_score,address_score
		...
		FROM (
			...
			SELECT i.chirp_id, s.patient_id,
				...
				,s.mother_last_name,b.mom_snam,b.mom_fnam,s.mother_first_name
