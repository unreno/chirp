...
CREATE TABLE vital.deaths (
	...
	alias_name VARCHAR(1),
	full_name VARCHAR(25),
	death_year VARCHAR(4),
	death_month VARCHAR(2),
	death_day VARCHAR(2),
	state_of_death VARCHAR(2),
	city_of_death VARCHAR(3),
	county_of_death VARCHAR(2),
	death_facility_code VARCHAR(4),
	...
	method_of_disposition VARCHAR(1),
	unknown04 VARCHAR(3),
	certifier_type VARCHAR(1),
	...
	communicable_disease VARCHAR(1),
	autopsy_performed VARCHAR(1),
	tobacco_use VARCHAR(1),
	female_pregnant VARCHAR(1),
	injury_at_work VARCHAR(1),
	injury_place VARCHAR(2),
	transportation_injury VARCHAR(1),
	transportation_injury_lit VARCHAR(1),
	unknown05 VARCHAR(1),
	birth_year_2 VARCHAR(4),
	...
	hispanic_code VARCHAR(3),
	unknown07 VARCHAR(3),
	bridged_race VARCHAR(2),
	unknown08 VARCHAR(3),
	death_year_2 VARCHAR(4),
	unknown09 VARCHAR(1),
