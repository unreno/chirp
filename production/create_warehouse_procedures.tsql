...
BEGIN
	...
	INSERT INTO observations
		(chirp_id, provider_id, location_id, started_at, value_type, concept, s_value, downloaded_from, downloaded_at) 
		SELECT chirp_id, provider_id, location_id, started_at, value_type, concept, s_value, downloaded_from, downloaded_at
		FROM (
			SELECT i.chirp_id, b.date_of_birth AS started_at, 
				'123' AS provider_id,
				'456' AS location_id,
				'S' as value_type,
				CONVERT(VARCHAR(255), b.sex) AS [birth:sex],
	...
	INSERT INTO observations
		(chirp_id, provider_id, location_id, started_at, value_type, concept, t_value, downloaded_from, downloaded_at) 
		SELECT chirp_id, provider_id, location_id, started_at, value_type, concept, t_value, downloaded_from, downloaded_at
		FROM (
			SELECT i.chirp_id, b.date_of_birth AS started_at, 
				'123' AS provider_id,
				'456' AS location_id,
	...
	INSERT INTO observations
		(chirp_id, provider_id, location_id, started_at, value_type, concept, n_value, downloaded_from, downloaded_at) 
		SELECT chirp_id, provider_id, location_id, started_at, value_type, concept, n_value, downloaded_from, downloaded_at
		FROM (
			SELECT i.chirp_id, b.date_of_birth AS started_at, 
				'123' AS provider_id,
				'456' AS location_id,
