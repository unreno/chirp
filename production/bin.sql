...
--			('ac_othlit', bin.decode('vital','births','ac_othlit',ac_othlit), NULL),
...
--			('acn_chromothlit', bin.decode('vital','births','acn_chromothlit',acn_chromothlit), NULL),
			('acn_circ', bin.decode('vital','births','acn_circ',acn_circ), NULL),
--			('acn_cirlit', bin.decode('vital','births','acn_cirlit',acn_cirlit), NULL),
...
--			('acn_gastrolit', bin.decode('vital','births','acn_gastrolit',acn_gastrolit), NULL),
...
--			('acn_musclelit', bin.decode('vital','births','acn_musclelit',acn_musclelit), NULL),
			('acn_nervous', bin.decode('vital','births','acn_nervous',acn_nervous), NULL),
--			('acn_nervouslit', bin.decode('vital','births','acn_nervouslit',acn_nervouslit), NULL),
...
--			('acn_othlit', bin.decode('vital','births','acn_othlit',acn_othlit), NULL),
...
--			('acn_urogenlit', bin.decode('vital','births','acn_urogenlit',acn_urogenlit), NULL),
			('alcohol', bin.decode('vital','births','alcohol',alcohol), NULL),
			('apgar_10', bin.decode('vital','births','apgar_10',apgar_10), NULL),
			('apgar_5', bin.decode('vital','births','apgar_5',apgar_5), NULL),
			...
			('birth_da', bin.decode('vital','births','birth_da',birth_da), NULL),
			('birth_mo', bin.decode('vital','births','birth_mo',birth_mo), NULL),
			('birth_rco', bin.decode('vital','births','birth_rco',birth_rco), NULL),
			('birth_st', bin.decode('vital','births','birth_st',birth_st), NULL),
			('birth_yr', bin.decode('vital','births','birth_yr',birth_yr), NULL),
...
--			('bth_date', bin.decode('vital','births','bth_date',bth_date), NULL),
			...
			('bth_time', bin.decode('vital','births','bth_time',bth_time), NULL),
			('bthwt_unit', bin.decode('vital','births','bthwt_unit',bthwt_unit), NULL),
			('bwt_grp', bin.decode('vital','births','bwt_grp',bwt_grp), NULL),
			('cer_da', bin.decode('vital','births','cer_da',cer_da), NULL),
--			('cer_date', bin.decode('vital','births','cer_date',cer_date), NULL),
			('cer_mo', bin.decode('vital','births','cer_mo',cer_mo), NULL),
			('cer_yr', bin.decode('vital','births','cer_yr',cer_yr), NULL),
...
--			('cld_othlit', bin.decode('vital','births','cld_othlit',cld_othlit), NULL),
...
--			('dat_concep', bin.decode('vital','births','dat_concep',dat_concep), NULL),
			('death_cert', bin.decode('vital','births','death_cert',death_cert), NULL),
--			('death_date', bin.decode('vital','births','death_date',death_date), NULL),
			('death_match', bin.decode('vital','births','death_match',death_match), NULL),
			('del_wt', bin.decode('vital','births','del_wt',del_wt), NULL),
			('drink_wk', bin.decode('vital','births','drink_wk',drink_wk), NULL),
...
--			('du_otherlit', bin.decode('vital','births','du_otherlit',du_otherlit), NULL),
			('du_prscr', bin.decode('vital','births','du_prscr',du_prscr), NULL),
			('fa_age', bin.decode('vital','births','fa_age',fa_age), NULL),
			('fa_age1', bin.decode('vital','births','fa_age1',fa_age1), NULL),
			('fa_amind', bin.decode('vital','births','fa_amind',fa_amind), NULL),
--			('fa_amindlit', bin.decode('vital','births','fa_amindlit',fa_amindlit), NULL),
			('fa_asian', bin.decode('vital','births','fa_asian',fa_asian), NULL),
--			('fa_asianlit', bin.decode('vital','births','fa_asianlit',fa_asianlit), NULL),
...
--			('fa_dob', bin.decode('vital','births','fa_dob',fa_dob), NULL),
...
--			('fa_ethothlit', bin.decode('vital','births','fa_ethothlit',fa_ethothlit), NULL),
...
--			('fa_pacisllit', bin.decode('vital','births','fa_pacisllit',fa_pacisllit), NULL),
...
--			('fa_raceothlit', bin.decode('vital','births','fa_raceothlit',fa_raceothlit), NULL),
...
--			('fa_xname', bin.decode('vital','births','fa_xname',fa_xname), NULL),
			...
			('gest_days', bin.decode('vital','births','gest_days',gest_days), NULL),
			('gest_est', bin.decode('vital','births','gest_est',gest_est), NULL),
			('gest_grp', bin.decode('vital','births','gest_grp',gest_grp), NULL),
--			('gest_wks', bin.decode('vital','births','gest_wks',gest_wks), NULL),
--			('grams', bin.decode('vital','births','grams',grams), NULL),
...
--			('inf_othlit', bin.decode('vital','births','inf_othlit',inf_othlit), NULL),
...
--			('lbs', bin.decode('vital','births','lbs',lbs), NULL),
			...
			('lm_da', bin.decode('vital','births','lm_da',lm_da), NULL),
--			('lm_date', bin.decode('vital','births','lm_date',lm_date), NULL),
			('lm_mo', bin.decode('vital','births','lm_mo',lm_mo), NULL),
			('lm_yr', bin.decode('vital','births','lm_yr',lm_yr), NULL),
...
--			('mom_bthcntry_fips', bin.decode('vital','births','mom_bthcntry_fips',mom_bthcntry_fips), NULL),
--			('mom_bthstate_fips', bin.decode('vital','births','mom_bthstate_fips',mom_bthstate_fips), NULL),
...
--			('mom_dob', bin.decode('vital','births','mom_dob',mom_dob), NULL),
...
--			('mom_ethothlit', bin.decode('vital','births','mom_ethothlit',mom_ethothlit), NULL),
...
--			('mom_hospnum', bin.decode('vital','births','mom_hospnum',mom_hospnum), NULL),
			('mom_htft', bin.decode('vital','births','mom_htft',mom_htft), NULL),
			('mom_htinch', bin.decode('vital','births','mom_htinch',mom_htinch), NULL),
...
--			('mom_pacisllit', bin.decode('vital','births','mom_pacisllit',mom_pacisllit), NULL),
...
--			('mom_raceothlit', bin.decode('vital','births','mom_raceothlit',mom_raceothlit), NULL),
...
--			('mres_cntry_fips', bin.decode('vital','births','mres_cntry_fips',mres_cntry_fips), NULL),
			('mres_cnty_fips', bin.decode('vital','births','mres_cnty_fips',mres_cnty_fips), NULL),
--			('mres_st_fips', bin.decode('vital','births','mres_st_fips',mres_st_fips), NULL),
...
--			('mrf_othlit', bin.decode('vital','births','mrf_othlit',mrf_othlit), NULL),
...
--			('ob_othlit', bin.decode('vital','births','ob_othlit',ob_othlit), NULL),
...
--			('oz', bin.decode('vital','births','oz',oz), NULL),
			...
			('pre_begda', bin.decode('vital','births','pre_begda',pre_begda), NULL),
--			('pre_begin', bin.decode('vital','births','pre_begin',pre_begin), NULL),
			('pre_begmo', bin.decode('vital','births','pre_begmo',pre_begmo), NULL),
			('pre_begyr', bin.decode('vital','births','pre_begyr',pre_begyr), NULL),
--			('pre_end', bin.decode('vital','births','pre_end',pre_end), NULL),
			('pre_endda', bin.decode('vital','births','pre_endda',pre_endda), NULL),
			('pre_endmo', bin.decode('vital','births','pre_endmo',pre_endmo), NULL),
			('pre_endyr', bin.decode('vital','births','pre_endyr',pre_endyr), NULL),
...
--			('reg_date', bin.decode('vital','births','reg_date',reg_date), NULL),
			('reg_mo', bin.decode('vital','births','reg_mo',reg_mo), NULL),
			('reg_yr', bin.decode('vital','births','reg_yr',reg_yr), NULL),
