...
--			(                  'father_ssn',                   CAST(father_ssn AS VARCHAR(255)), NULL),
			...
			(       'b2_mother_height_feet',        CAST(b2_mother_height_feet AS VARCHAR(255)), NULL),
			(       'b2_mother_height_inch',        CAST(b2_mother_height_inch AS VARCHAR(255)), NULL),
			(       'b2_mother_pre_preg_wt',        CAST(b2_mother_pre_preg_wt AS VARCHAR(255)), NULL),
			(       'b2_mother_wt_at_deliv',        CAST(b2_mother_wt_at_deliv AS VARCHAR(255)), NULL),
...
--					WHEN b._date_of_birth_date BETWEEN DATEADD(day,-8,s.dob) AND DATEADD(day,8,s.dob) THEN 0.5
				...
				CASE WHEN b._mother_res_addr1 = a._address_line1 THEN 1.0
					WHEN b._mother_res_addr1 = a._address_line1_prehash THEN 1.0
					WHEN b._mother_res_addr1_pre = a._address_line1_pre THEN 0.5
