...
BEGIN
	...
	INSERT INTO dbo.observations
		...
		CROSS APPLY ( VALUES
			...
			('DEM:DOB', CAST(bth_date AS VARCHAR), NULL),
			...
			('cer_date', CAST(cer_date AS VARCHAR), NULL),
...
--			('cert_yr', bin.decode('vital','births','cert_yr',cert_yr), NULL),
			...
			('dat_concep', CAST(dat_concep AS VARCHAR), NULL),
			('death_cert', bin.decode('vital','births','death_cert',death_cert), NULL),
			('death_date', CAST(death_date AS VARCHAR), NULL),
			...
			('fa_dob', CAST(fa_dob AS VARCHAR), NULL),
...
--			('fa_xname', bin.decode('vital','births','fa_xname',fa_xname), NULL),
			...
			('gest_wks', CAST(gest_wks AS VARCHAR), NULL),
			('grams', CAST(grams AS VARCHAR), NULL),
...
--			('lbs', bin.decode('vital','births','lbs',lbs), NULL),
			...
			('lm_date', CAST(lm_date AS VARCHAR), NULL),
...
--			('mom_address', bin.decode('vital','births','mom_address',mom_address), NULL),
			...
			('mom_dob', CAST(mom_dob AS VARCHAR), NULL),
...
--			('oz', bin.decode('vital','births','oz',oz), NULL),
			...
			('reg_date', CAST(reg_date AS VARCHAR), NULL),
...
--			('void', bin.decode('vital','births','void',void), NULL),
			...
			('DEM:Weight', CAST(
				bin.weight_from_lbs_and_oz( lbs, oz ) AS VARCHAR), 'lbs')
		) cav ( concept, value, units )
		WHERE cav.value IS NOT NULL
