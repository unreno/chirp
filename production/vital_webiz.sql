...
--	clinic_id	INT, --	System Assigned Number used for Primary key
	...
	history_address_line1	VARCHAR(50), --	Line 1 of the address
	history_city_desc_1	VARCHAR(50), --	Name of the City. Displayed in some dropdowns, reports, etc. within the application.
	history_zip_code	VARCHAR(10), --	The Zip Code portion of the address
	history_county_desc_1	VARCHAR(50), --	Name of the County. Displayed in some dropdowns, reports, etc. within the application.
	history_city_desc_2	VARCHAR(50), --	Name of the City. Displayed in some dropdowns, reports, etc. within the application.
	history_county_desc_2	VARCHAR(50), --	Name of the County. Displayed in some dropdowns, reports, etc. within the application.
	history_state_desc	VARCHAR(50), --	Full description for the state
	history_country_desc	VARCHAR(50), --	Name of the Country. Displayed in some dropdowns, reports, etc. within the application.
...
--	patient_id|last_name|first_name|middle_name|dob|po_box|street_number|street_prefix_desc|street_name|street_type_desc|city_desc|apt_number|zip_code|county_desc|race_desc|ethnicity_desc|gender_code|mother_last_name|mother_first_name|mother_maiden_name|telephone|ssn|local_id|vaccination_desc|vaccination_date|patient_vaccination_id|dosage_num|npi|provider_desc|street_number|street_prefix_desc|street_name|street_type_desc|city_desc|clinic_desc|street_number|street_prefix_desc|street_name|street_type_desc|city_desc|address_line1|city_desc|zip_code|county_desc|city_desc|county_desc|state_desc|country_desc|health_insurance_desc
...
CREATE VIEW vital.bulk_insert_webizs AS SELECT
	...
	clinic_city_desc,
	history_address_line1,
	history_city_desc_1,
	history_zip_code,
	history_county_desc_1,
	history_city_desc_2,
	history_county_desc_2,
	history_state_desc,
	history_country_desc,
